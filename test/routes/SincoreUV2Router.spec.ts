...
import { SincoreUV2Router } from '../../typechain/SincoreUV2Router'
...
describe('SincoreUV2Router UNI-ETH-SUSHI', () => {
  let router: SincoreUV2Router
  let dai: IERC20
  let usdc: IERC20
  let usdt: IERC20
  let susd: IERC20
  ...
  beforeEach(async () => {
    const Router = await ethers.getContractFactory('SincoreUV2Router')
...
describe('SincoreUV2Router2 UNI-USDC-UNI', () => {
  let router: SincoreUV2Router
  let dai: IERC20
  let usdc: IERC20
  let usdt: IERC20
...
describe('SincoreUV2Router2 UNI-USDC-SUSHI', () => {
  let router: SincoreUV2Router
  let dai: IERC20
  let usdc: IERC20
  let usdt: IERC20
...
describe('SincoreUV2Router2 UNI-ETH-UNI-USDC-SUSHI', () => {
  let router: SincoreUV2Router
  let dai: IERC20
  let usdc: IERC20
  let usdt: IERC20
