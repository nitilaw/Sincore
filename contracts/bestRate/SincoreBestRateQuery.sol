...
contract SincoreBestRateQuery {
    ...
    returns (uint256) // amountOut 
    {
        ...
        // uint256 _amountOut = Sincore.getDestinationReturnAmount(routes[i], src, dest, srcAmount, PARTNER_INDEX);
        bytes memory payload = abi.encodeWithSelector(Sincore.getDestinationReturnAmount.selector, route, src, dest, srcAmount, PARTNER_INDEX);
